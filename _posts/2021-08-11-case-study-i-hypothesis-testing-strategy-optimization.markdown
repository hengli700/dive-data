...
For those reasons, "purchase" column will be used as the label. After further examining the data set, it was found out that this data set is imbalanced, which needs balancing by making the # of observations
